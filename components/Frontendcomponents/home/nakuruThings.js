                ...
                <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-col-1 gap-7">
                    <div className="mb-0">
                        <div className="relative pb-[65%] overflow-hidden mb-5">
                            <Image src="/images/things/1.png" alt="It is a long established fact that a reader." width={270} height={175} className="absolute top-0 left-0 w-full h-full object-cover"/>
                        </div>
                    ...
                    <div className="mb-0">
                        <div className="relative pb-[65%] overflow-hidden mb-5">
                            <Image src="/images/things/2.png" alt="The standard chunk of Lorem Ipsum used." width={270} height={175} className="absolute top-0 left-0 w-full h-full object-cover"/>
                        </div>
                    ...
                    <div className="mb-0">
                        <div className="relative pb-[65%] overflow-hidden mb-5">
                            <Image src="/images/things/3.png" alt="It uses a dictionary of over 200 Latin words." width={270} height={175} className="absolute top-0 left-0 w-full h-full object-cover"/>
                        </div>
                    ...
                    <div className="mb-0">
                        <div className="relative pb-[65%] overflow-hidden mb-5">
                            <Image src="/images/things/4.png" alt="It has survived not only five centuries." width={270} height={175} className="absolute top-0 left-0 w-full h-full object-cover"/>
                        </div>

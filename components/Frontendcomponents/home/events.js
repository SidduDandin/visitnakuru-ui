                        ...
                        <div className="swiper-wrapper">
                            <div className="swiper-slide">
                                <div className="relative pb-[65%] overflow-hidden mb-5">
                                    <Image src="/images/events/1.png" alt="Red Rose Decoration" width={270} height={175} className="absolute top-0 left-0 w-full h-full object-cover"/>
                                </div>
                            ...
                            <div className="swiper-slide">
                                <div className="relative pb-[65%] overflow-hidden mb-5">
                                    <Image src="/images/events/2.png" alt="Adventure Activities" width={270} height={175} className="absolute top-0 left-0 w-full h-full object-cover"/>
                                </div>
                                <p className="mb-2.5">20 Aug 2025 - 10 Sep 2025</p>
                            ...
                            <div className="swiper-slide">
                                <div className="relative pb-[65%] overflow-hidden mb-5">
                                    <Image src="/images/events/3.png" alt="Dinner With Strangers" width={270} height={175} className="absolute top-0 left-0 w-full h-full object-cover"/>
                                </div>
                                <p className="mb-2.5">20 Aug 2025 - 10 Sep 2025</p>
                            ...
                            <div className="swiper-slide">
                                <div className="relative pb-[65%] overflow-hidden mb-5">
                                    <Image src="/images/events/4.png" alt="Villain Academy" width={270} height={175} className="absolute top-0 left-0 w-full h-full object-cover"/>
                                </div>
                                <p className="mb-2.5">20 Aug 2025 - 10 Sep 2025</p>

                ...
                <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-col-1 gap-7">
                    <div className="mb-0">
                        <div className="relative pb-[65%] overflow-hidden mb-5">
                            <Image src="/images/explore/1.png" alt="Tour Operators" width={270} height={175} className="absolute top-0 left-0 w-full h-full object-cover"/>
                        </div>
                    ...
                    <div className="mb-0">
                        <div className="relative pb-[65%] overflow-hidden mb-5">
                            <Image src="/images/explore/2.png" alt="Travel Agencies" width={270} height={175} className="absolute top-0 left-0 w-full h-full object-cover"/>
                        </div>
                    ...
                    <div className="mb-0">
                        <div className="relative pb-[65%] overflow-hidden mb-5">
                            <Image src="/images/explore/3.png" alt="Car Rentals" width={270} height={175} className="absolute top-0 left-0 w-full h-full object-cover"/>
                        </div>
                    ...
                    <div className="mb-0">
                        <div className="relative pb-[65%] overflow-hidden mb-5">
                            <Image src="/images/explore/4.png" alt="Adventure Safaris" width={270} height={175} className="absolute top-0 left-0 w-full h-full object-cover"/>
                        </div>

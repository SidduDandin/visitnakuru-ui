						...
						<div className="swiper-wrapper">
							<div className="swiper-slide">
								<div className="relative md:pb-[140%] pb-[100%] overflow-hidden mb-5">
									<Image src="/images/trendings/1.png" alt="It is a long established fact that a reader." width={270} height={370} className="absolute top-0 left-0 w-full h-full object-cover"/>
								</div>
							...
							<div className="swiper-slide">
								<div className="relative md:pb-[140%] pb-[100%] overflow-hidden mb-5">
									<Image src="/images/trendings/2.png" alt="There are many variations of passages." width={270} height={370} className="absolute top-0 left-0 w-full h-full object-cover"/>
								</div>
							...
							<div className="swiper-slide">
								<div className="relative md:pb-[140%] pb-[100%] overflow-hidden mb-5">
									<Image src="/images/trendings/3.png" alt="It has survived not only five centuries." width={270} height={370} className="absolute top-0 left-0 w-full h-full object-cover"/>
								</div>
							...
							<div className="swiper-slide">
								<div className="relative md:pb-[140%] pb-[100%] overflow-hidden mb-5">
									<Image src="/images/trendings/4.png" alt="The standard chunk of Lorem Ipsum used." width={270} height={370} className="absolute top-0 left-0 w-full h-full object-cover"/>
								</div>

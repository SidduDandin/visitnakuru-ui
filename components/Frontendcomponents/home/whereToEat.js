                ...
                <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-col-1 gap-7">
                    <div className="mb-0">
                        <div className="relative pb-[65%] overflow-hidden mb-5">
                            <Image src="/images/eat/1.png" alt="Java House Nakuru" width={270} height={175} className="absolute top-0 left-0 w-full h-full object-cover"/>
                        </div>
                    ...
                    <div className="mb-0">
                        <div className="relative pb-[65%] overflow-hidden mb-5">
                            <Image src="/images/eat/2.png" alt="Taidy’s Restaurant" width={270} height={175} className="absolute top-0 left-0 w-full h-full object-cover"/>
                        </div>
                    ...
                    <div className="mb-0">
                        <div className="relative pb-[65%] overflow-hidden mb-5">
                            <Image src="/images/eat/3.png" alt="Culture Mambo Lounge" width={270} height={175} className="absolute top-0 left-0 w-full h-full object-cover"/>
                        </div>
                    ...
                    <div className="mb-0">
                        <div className="relative pb-[65%] overflow-hidden mb-5">
                            <Image src="/images/eat/4.png" alt="Merica Hotel" width={270} height={175} className="absolute top-0 left-0 w-full h-full object-cover"/>
                        </div>

            ...
            <div className="hero-banner-slider swiper">
                <div className="swiper-wrapper">
                    <div className="swiper-slide">
                        <div className="bg-cover bg-no-repeat bg-center md:min-h-[550px] min-h-[450px] flex items-center justify-center py-7 px-10 before:content-[''] before:absolute before:top-0 before:left-0 before:w-[100%] before:h-[100%] before:bg-black before:opacity-25 text-white text-center" style={{ "backgroundImage" : "url(/images/banner/banner-1.png)"}}>

...
export default function Footer() {
  ...
  return (
    <>
      {!hidelayout && (<footer className="bg-dark-gray text-white">
        <div className="container">
            ...
            <div className="md:mb-12 mb-9">
              <ul className="flex flex-wrap justify-center font-interstate md:text-[18px] text-[16px] font-normal ">
                <li className="after:content-['|'] after:mx-2 last:after:content-none">
                  <Link href="#" className="text-white hover:underline">Whats on</Link>
                </li>
                <li className="after:content-['|'] after:mx-2 last:after:content-none">
                  <Link href="#" className="text-white hover:underline">Things to do</Link>
                </li>
                <li className="after:content-['|'] after:mx-2 last:after:content-none">
                  <Link href="#" className="text-white hover:underline">Food & Drink</Link>
                </li>
                <li className="after:content-['|'] after:mx-2 last:after:content-none">
                  <Link href="#" className="text-white hover:underline">Accommodation</Link>
                </li>
                <li className="after:content-['|'] after:mx-2 last:after:content-none">
                  <Link href="#" className="text-white hover:underline">Shopping</Link>
                </li>
                <li className="after:content-['|'] after:mx-2 last:after:content-none">
                  <Link href="#" className="text-white hover:underline">Visitor information</Link>
                </li>
                <li className="after:content-['|'] after:mx-2 last:after:content-none">
                ...
                <li>
                  <Link href="#" className="border border-white rounded-full flex items-center justify-center md:p-2 p-2.5 md:w-[60px] md:h-[60px] w-[40px] h-[40px] hover:bg-white hover:text-dark-gray transition">
                    <svg width="13" height="24" viewBox="0 0 13 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="max-h-full w-auto">
                      <path d="M3.61949 13.5469H0.633411C0.150812 13.5469 0 13.3667 0 12.9161V9.2816C0 8.801 0.180975 8.65081 0.633411 8.65081H3.61949V6.00751C3.61949 4.80601 3.83063 3.66458 4.43387 2.61327C5.06729 1.53191 5.97216 0.811014 7.11833 0.390488C7.87239 0.12015 8.62645 0 9.44084 0H12.3968C12.819 0 13 0.180225 13 0.600751V4.02503C13 4.44556 12.819 4.62578 12.3968 4.62578C11.5824 4.62578 10.768 4.62578 9.9536 4.65582C9.13921 4.65582 8.71694 5.04631 8.71694 5.88736C8.68678 6.78849 8.71694 7.65957 8.71694 8.59074H12.2158C12.6984 8.59074 12.8794 8.77096 12.8794 9.25156V12.8861C12.8794 13.3667 12.7285 13.5169 12.2158 13.5169H8.71694V23.3091C8.71694 23.8198 8.56613 24 8.0232 24H4.2529C3.80046 24 3.61949 23.8198 3.61949 23.3692V13.5469Z" fill="currentcolor"/>
                    </svg>
                  </Link>
                </li>
                <li>
          ...
          <div className="py-6 border-t border-[rgba(255,255,255,0.2)] text-center">
            <p className="mb-0 md:text-[16px] text-[14px]">© 2025 Visit Nakuru. All Rights Reserved. <Link href="terms-condition">Terms & Conditions</Link>  |  <Link href="privacy-policy">Privacy Policy</Link></p>
          </div>
        </div>
    </footer>)}
    </>
